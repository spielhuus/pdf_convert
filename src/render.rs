...
use pdf::{
    content::{Cmyk, Matrix, Op, Point, Rect, Rgb, Winding, Color},
...
fn convert_color2<'a>(cs: &mut &'a ColorSpace, color: &Color, resources: &Resources, mode: BlendMode) -> Result<Fill, PdfError> {
    match *color {
        Color::Gray(g) => {
